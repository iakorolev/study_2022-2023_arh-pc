...
![Рис.1.Создание учетной записи на GitHub](/image/3.png){ #fig:fig1 width=70% }
...
![Рис.2.Указываем имя и email](/image/6.png){ #fig:fig2 width=70% }

Настрою utf-8 в выводе сообщений git(рис.3 [-@fig:3])

![Рис.3.Настройка utf-8](/image/9.png){ #fig:fig3 width=70% }

Задам имя начальной ветки(рис.4 [-@fig:4])

![Рис.4. Имя начальной ветки](/image/12.png){ #fig:fig4 width=70% }

Параметр autocrlf(рис.5 [-@fig:5])

![Рис.5.Параметр autocrlf](/image/15.png){ #fig:fig5 width=70% }

Параметр safecrlf(рис.6 [-@fig:6])

![Рис.6. Параметр safecrlf](/image/17.png){ #fig:fig6 width=70% }
